    ...
    <div class="container col-md-9 col-sm-12 mt-5 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-5">
                <div class="card">
                    <img width="100%" height="200px" src="/assets/images/placeholder.png" class="group-image card-img-top object-fit-cover group-img" />
                        ...
                        <form id="form-create-group">
                            ...
                            <div id="second-step" class="d-none">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" class="group-name form-control form-control-lg" placeholder="Nome do grupo">
                                </div>
